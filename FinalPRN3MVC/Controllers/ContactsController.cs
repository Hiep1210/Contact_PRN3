    ...
    public class ContactsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Contacts != null ? 
                          ...
                          Problem("Entity set 'lovetientdContext.Contacts'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ContactName")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ContactName")] Contact contact)
        {
            if (id != contact.Id)
            {
                return NotFound();
